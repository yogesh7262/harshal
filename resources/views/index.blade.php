                                ...
                                <div class="row align-items-center justify-content-between">
                                    ...
                                    <div class="col-auto d-none d-xl-block">
                                        <div class="header-button">
                                            ...
                                            <a href="{{url('login')}}" class="th-btn style8 d-none d-xxl-inline-block">Apply Now<i class="fas fa-arrow-right ms-2"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-12">
                            <div class="hero-style3 text-center">
                                <span class="hero-subtitle text-white" data-ani="slideinup" data-ani-delay="0.1s">The World’s Best Institute Of</span>
                                <h1 class="hero-title text-white" data-ani="slideinup" data-ani-delay="0.4s">Online Education</h1>
                                ...
                                <div class="btn-group justify-content-center" data-ani="slideinup" data-ani-delay="0.7s">
                                    <a href="{{url('login')}}" class="th-btn style3">Admission Now<i class="fa-regular fa-arrow-right ms-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="th-hero-slide">
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-12">
                            <div class="hero-style3 text-center">
                                <span class="hero-subtitle text-white" data-ani="slideinup" data-ani-delay="0.1s">Unlock The Power Of Learning</span>
                                <h1 class="hero-title text-white" data-ani="slideinup" data-ani-delay="0.4s">Empower Your Future</h1>
                                <div class="hero-text text-white" data-ani="slideinup" data-ani-delay="0.5s">
                                    <p>Admission Going On, Hurry To Enroll Now </p>
                                    <ul class="counter-list cta-countdown" data-offer-date="10/24/2023">
                                        <li>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        ...
                        <div class="service-card-content">
                            ...
                            <p class="service-card-text">Discover different career paths and industries, along with the required skills, education.</p>
                            <div class="service-card-img">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        ...
                        <div class="service-card-content">
                            ...
                            <p class="service-card-text">Gain insights into how parents can support their childs educational journey.</p>
                            <div class="service-card-img">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6">
                    <div class="space">
                        ...
                        <p class="mt-n2 mb-30">Synergistically visualize alternative content before cross functional core Rapidiously administra standardized value via focused benefits. Rapidiously redefine highly efficient niche markets with plug-and-play materials professionally seize client centric solutions</p>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="btn-group mt-15">
                            ...
                            <a href="about.html" class="th-btn style7">CONTACT US<i class="fa-regular fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row th-carousel" data-slide-show="3" data-lg-slide-show="2" data-md-slide-show="1" data-sm-slide-show="1" data-arrows="true">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style4">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="assets/img/blog/blog-3-2.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.html"><i class="fa-light fa-user"></i>by David Smith</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style4">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="assets/img/blog/blog-3-3.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.html"><i class="fa-light fa-user"></i>by David Smith</a>
